...
def generate_response(history, user_input):
    ...
    prompt_input = "Create a linked post of around 120 words on this: " + user_input
    ...
    if output_text.startswith(prompt_input):
        response = output_text[len(prompt_input):].strip()
    else:
